...
export declare type ClusterActivityStream = import("./clusterActivityStream").ClusterActivityStream;
...
export declare type ClusterEndpoint = import("./clusterEndpoint").ClusterEndpoint;
...
export declare type ClusterInstance = import("./clusterInstance").ClusterInstance;
...
export declare type ClusterParameterGroup = import("./clusterParameterGroup").ClusterParameterGroup;
...
export declare type ClusterRoleAssociation = import("./clusterRoleAssociation").ClusterRoleAssociation;
...
export declare type ClusterSnapshot = import("./clusterSnapshot").ClusterSnapshot;
...
export declare type EventSubscription = import("./eventSubscription").EventSubscription;
...
export declare type GlobalCluster = import("./globalCluster").GlobalCluster;
...
export declare type InstanceAutomatedBackupsReplication = import("./instanceAutomatedBackupsReplication").InstanceAutomatedBackupsReplication;
...
export declare type OptionGroup = import("./optionGroup").OptionGroup;
...
export declare type ProxyDefaultTargetGroup = import("./proxyDefaultTargetGroup").ProxyDefaultTargetGroup;
...
export declare type ProxyEndpoint = import("./proxyEndpoint").ProxyEndpoint;
...
export declare type ProxyTarget = import("./proxyTarget").ProxyTarget;
...
export declare type RoleAssociation = import("./roleAssociation").RoleAssociation;
...
export declare type SnapshotCopy = import("./snapshotCopy").SnapshotCopy;
...
export declare type SubnetGroup = import("./subnetGroup").SubnetGroup;
