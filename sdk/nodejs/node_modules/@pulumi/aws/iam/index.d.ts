...
export declare type AccessKey = import("./accessKey").AccessKey;
...
export declare type AccountAlias = import("./accountAlias").AccountAlias;
...
export declare type AccountPasswordPolicy = import("./accountPasswordPolicy").AccountPasswordPolicy;
...
export declare type GroupPolicy = import("./groupPolicy").GroupPolicy;
...
export declare type GroupPolicyAttachment = import("./groupPolicyAttachment").GroupPolicyAttachment;
...
export declare type PolicyAttachment = import("./policyAttachment").PolicyAttachment;
...
export declare type RolePolicy = import("./rolePolicy").RolePolicy;
...
export declare type RolePolicyAttachment = import("./rolePolicyAttachment").RolePolicyAttachment;
...
export declare type SamlProvider = import("./samlProvider").SamlProvider;
...
export declare type ServerCertificate = import("./serverCertificate").ServerCertificate;
...
export declare type ServiceLinkedRole = import("./serviceLinkedRole").ServiceLinkedRole;
...
export declare type ServiceSpecificCredential = import("./serviceSpecificCredential").ServiceSpecificCredential;
...
export declare type SigningCertificate = import("./signingCertificate").SigningCertificate;
...
export declare type UserGroupMembership = import("./userGroupMembership").UserGroupMembership;
...
export declare type UserLoginProfile = import("./userLoginProfile").UserLoginProfile;
...
export declare type UserPolicy = import("./userPolicy").UserPolicy;
...
export declare type UserPolicyAttachment = import("./userPolicyAttachment").UserPolicyAttachment;
...
export declare type VirtualMfaDevice = import("./virtualMfaDevice").VirtualMfaDevice;
