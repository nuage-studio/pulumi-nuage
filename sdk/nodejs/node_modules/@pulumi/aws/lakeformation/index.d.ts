...
export declare type DataLakeSettings = import("./dataLakeSettings").DataLakeSettings;
...
export declare type LfTag = import("./lfTag").LfTag;
...
export declare type ResourceLfTags = import("./resourceLfTags").ResourceLfTags;
