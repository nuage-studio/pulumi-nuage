...
export declare type Framework = import("./framework").Framework;
...
export declare type VaultLockConfiguration = import("./vaultLockConfiguration").VaultLockConfiguration;
...
export declare type VaultNotifications = import("./vaultNotifications").VaultNotifications;
...
export declare type VaultPolicy = import("./vaultPolicy").VaultPolicy;
