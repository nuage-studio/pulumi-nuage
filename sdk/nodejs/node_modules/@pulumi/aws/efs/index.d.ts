...
export declare type BackupPolicy = import("./backupPolicy").BackupPolicy;
...
export declare type FileSystem = import("./fileSystem").FileSystem;
...
export declare type FileSystemPolicy = import("./fileSystemPolicy").FileSystemPolicy;
...
export declare type MountTarget = import("./mountTarget").MountTarget;
