...
export declare type CatalogDatabase = import("./catalogDatabase").CatalogDatabase;
...
export declare type CatalogTable = import("./catalogTable").CatalogTable;
...
export declare type Classifier = import("./classifier").Classifier;
...
export declare type Crawler = import("./crawler").Crawler;
...
export declare type DataCatalogEncryptionSettings = import("./dataCatalogEncryptionSettings").DataCatalogEncryptionSettings;
...
export declare type DevEndpoint = import("./devEndpoint").DevEndpoint;
...
export declare type PartitionIndex = import("./partitionIndex").PartitionIndex;
...
export declare type ResourcePolicy = import("./resourcePolicy").ResourcePolicy;
...
export declare type SecurityConfiguration = import("./securityConfiguration").SecurityConfiguration;
...
export declare type Trigger = import("./trigger").Trigger;
...
export declare type UserDefinedFunction = import("./userDefinedFunction").UserDefinedFunction;
