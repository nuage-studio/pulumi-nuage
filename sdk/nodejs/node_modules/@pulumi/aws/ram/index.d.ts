...
export declare type PrincipalAssociation = import("./principalAssociation").PrincipalAssociation;
...
export declare type ResourceAssociation = import("./resourceAssociation").ResourceAssociation;
...
export declare type ResourceShare = import("./resourceShare").ResourceShare;
...
export declare type ResourceShareAccepter = import("./resourceShareAccepter").ResourceShareAccepter;
