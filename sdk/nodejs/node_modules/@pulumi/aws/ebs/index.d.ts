...
export declare type DefaultKmsKey = import("./defaultKmsKey").DefaultKmsKey;
...
export declare type EncryptionByDefault = import("./encryptionByDefault").EncryptionByDefault;
...
export declare type SnapshotImport = import("./snapshotImport").SnapshotImport;
export declare const SnapshotImport: typeof import("./snapshotImport").SnapshotImport;
export { VolumeArgs, VolumeState } from "./volume";
export declare type Volume = import("./volume").Volume;
