...
export declare type CloudFormationType = import("./cloudFormationType").CloudFormationType;
...
export declare type StackSetInstance = import("./stackSetInstance").StackSetInstance;
