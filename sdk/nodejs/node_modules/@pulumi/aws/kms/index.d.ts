...
export declare type ReplicaExternalKey = import("./replicaExternalKey").ReplicaExternalKey;
...
export declare type ReplicaKey = import("./replicaKey").ReplicaKey;
