...
exports.EntityRecognizer = exports.DocumentClassifier = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("../utilities");
exports.DocumentClassifier = null;
exports.EntityRecognizer = null;
    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:comprehend/documentClassifier:DocumentClassifier":
                return new exports.DocumentClassifier(name, undefined, { urn });
            case "aws:comprehend/entityRecognizer:EntityRecognizer":
                return new exports.EntityRecognizer(name, undefined, { urn });
            default:
