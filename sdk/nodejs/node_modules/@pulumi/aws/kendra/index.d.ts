...
export declare type Index = import("./index_").Index;
...
export declare type QuerySuggestionsBlockList = import("./querySuggestionsBlockList").QuerySuggestionsBlockList;
...
export declare type Thesaurus = import("./thesaurus").Thesaurus;
