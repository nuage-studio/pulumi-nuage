...
export declare type GeofenceCollection = import("./geofenceCollection").GeofenceCollection;
...
export declare type RouteCalculation = import("./routeCalculation").RouteCalculation;
...
export declare type Tracker = import("./tracker").Tracker;
...
export declare type TrackerAssociation = import("./trackerAssociation").TrackerAssociation;
