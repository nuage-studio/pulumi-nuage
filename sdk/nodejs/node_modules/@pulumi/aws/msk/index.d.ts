...
export declare type Configuration = import("./configuration").Configuration;
...
export declare type ScramSecretAssociation = import("./scramSecretAssociation").ScramSecretAssociation;
...
export declare type ServerlessCluster = import("./serverlessCluster").ServerlessCluster;
