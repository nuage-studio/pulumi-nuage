...
export declare type IndexingConfiguration = import("./indexingConfiguration").IndexingConfiguration;
...
export declare type LoggingOptions = import("./loggingOptions").LoggingOptions;
...
export declare type ProvisioningTemplate = import("./provisioningTemplate").ProvisioningTemplate;
...
export declare type ThingGroupMembership = import("./thingGroupMembership").ThingGroupMembership;
...
export declare type ThingPrincipalAttachment = import("./thingPrincipalAttachment").ThingPrincipalAttachment;
...
export declare type TopicRuleDestination = import("./topicRuleDestination").TopicRuleDestination;
