...
export declare type AccessPoint = import("./accessPoint").AccessPoint;
...
export declare type AccountPublicAccessBlock = import("./accountPublicAccessBlock").AccountPublicAccessBlock;
...
export declare type AnalyticsConfiguration = import("./analyticsConfiguration").AnalyticsConfiguration;
...
export declare type Bucket = import("./bucket").Bucket;
...
export declare type BucketAccelerateConfigurationV2 = import("./bucketAccelerateConfigurationV2").BucketAccelerateConfigurationV2;
...
export declare type BucketAclV2 = import("./bucketAclV2").BucketAclV2;
...
export declare type BucketCorsConfigurationV2 = import("./bucketCorsConfigurationV2").BucketCorsConfigurationV2;
...
export declare type BucketIntelligentTieringConfiguration = import("./bucketIntelligentTieringConfiguration").BucketIntelligentTieringConfiguration;
...
export declare type BucketLifecycleConfigurationV2 = import("./bucketLifecycleConfigurationV2").BucketLifecycleConfigurationV2;
...
export declare type BucketLoggingV2 = import("./bucketLoggingV2").BucketLoggingV2;
...
export declare type BucketMetric = import("./bucketMetric").BucketMetric;
...
export declare type BucketNotification = import("./bucketNotification").BucketNotification;
...
export declare type BucketObject = import("./bucketObject").BucketObject;
...
export declare type BucketObjectLockConfigurationV2 = import("./bucketObjectLockConfigurationV2").BucketObjectLockConfigurationV2;
...
export declare type BucketObjectv2 = import("./bucketObjectv2").BucketObjectv2;
...
export declare type BucketOwnershipControls = import("./bucketOwnershipControls").BucketOwnershipControls;
...
export declare type BucketPolicy = import("./bucketPolicy").BucketPolicy;
...
export declare type BucketPublicAccessBlock = import("./bucketPublicAccessBlock").BucketPublicAccessBlock;
...
export declare type BucketReplicationConfig = import("./bucketReplicationConfig").BucketReplicationConfig;
...
export declare type BucketRequestPaymentConfigurationV2 = import("./bucketRequestPaymentConfigurationV2").BucketRequestPaymentConfigurationV2;
...
export declare type BucketServerSideEncryptionConfigurationV2 = import("./bucketServerSideEncryptionConfigurationV2").BucketServerSideEncryptionConfigurationV2;
...
export declare type BucketV2 = import("./bucketV2").BucketV2;
...
export declare type BucketVersioningV2 = import("./bucketVersioningV2").BucketVersioningV2;
...
export declare type BucketWebsiteConfigurationV2 = import("./bucketWebsiteConfigurationV2").BucketWebsiteConfigurationV2;
