...
export declare type CompositeAlarm = import("./compositeAlarm").CompositeAlarm;
...
export declare type EventApiDestination = import("./eventApiDestination").EventApiDestination;
...
export declare type EventBusPolicy = import("./eventBusPolicy").EventBusPolicy;
...
export declare type EventConnection = import("./eventConnection").EventConnection;
...
export declare type EventPermission = import("./eventPermission").EventPermission;
...
export declare type EventRule = import("./eventRule").EventRule;
...
export declare type EventTarget = import("./eventTarget").EventTarget;
...
export declare type LogDestination = import("./logDestination").LogDestination;
...
export declare type LogDestinationPolicy = import("./logDestinationPolicy").LogDestinationPolicy;
...
export declare type LogGroup = import("./logGroup").LogGroup;
...
export declare type LogMetricFilter = import("./logMetricFilter").LogMetricFilter;
...
export declare type LogResourcePolicy = import("./logResourcePolicy").LogResourcePolicy;
...
export declare type LogSubscriptionFilter = import("./logSubscriptionFilter").LogSubscriptionFilter;
...
export declare type MetricAlarm = import("./metricAlarm").MetricAlarm;
...
export declare type MetricStream = import("./metricStream").MetricStream;
...
export declare type QueryDefinition = import("./queryDefinition").QueryDefinition;
