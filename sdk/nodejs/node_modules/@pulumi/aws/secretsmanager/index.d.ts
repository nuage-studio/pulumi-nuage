...
export declare type SecretPolicy = import("./secretPolicy").SecretPolicy;
...
export declare type SecretRotation = import("./secretRotation").SecretRotation;
...
export declare type SecretVersion = import("./secretVersion").SecretVersion;
