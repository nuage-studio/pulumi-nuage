...
export declare type AccessPointPolicy = import("./accessPointPolicy").AccessPointPolicy;
...
export declare type BucketLifecycleConfiguration = import("./bucketLifecycleConfiguration").BucketLifecycleConfiguration;
...
export declare type MultiRegionAccessPoint = import("./multiRegionAccessPoint").MultiRegionAccessPoint;
...
export declare type MultiRegionAccessPointPolicy = import("./multiRegionAccessPointPolicy").MultiRegionAccessPointPolicy;
...
export declare type ObjectLambdaAccessPoint = import("./objectLambdaAccessPoint").ObjectLambdaAccessPoint;
