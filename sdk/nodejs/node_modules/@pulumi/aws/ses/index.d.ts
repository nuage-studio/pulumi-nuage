...
export declare type ActiveReceiptRuleSet = import("./activeReceiptRuleSet").ActiveReceiptRuleSet;
...
export declare type ConfgurationSet = import("./confgurationSet").ConfgurationSet;
export declare const ConfgurationSet: typeof import("./confgurationSet").ConfgurationSet;
...
export declare type DomainDkim = import("./domainDkim").DomainDkim;
...
export declare type DomainIdentity = import("./domainIdentity").DomainIdentity;
...
export declare type DomainIdentityVerification = import("./domainIdentityVerification").DomainIdentityVerification;
...
export declare type EmailIdentity = import("./emailIdentity").EmailIdentity;
...
export declare type EventDestination = import("./eventDestination").EventDestination;
...
export declare type IdentityNotificationTopic = import("./identityNotificationTopic").IdentityNotificationTopic;
...
export declare type IdentityPolicy = import("./identityPolicy").IdentityPolicy;
...
export declare type MailFrom = import("./mailFrom").MailFrom;
...
export declare type ReceiptFilter = import("./receiptFilter").ReceiptFilter;
...
export declare type ReceiptRule = import("./receiptRule").ReceiptRule;
...
export declare type ReceiptRuleSet = import("./receiptRuleSet").ReceiptRuleSet;
...
export declare type Template = import("./template").Template;
