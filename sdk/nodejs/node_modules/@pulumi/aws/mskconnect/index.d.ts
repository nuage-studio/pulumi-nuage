...
export declare type CustomPlugin = import("./customPlugin").CustomPlugin;
...
export declare type WorkerConfiguration = import("./workerConfiguration").WorkerConfiguration;
