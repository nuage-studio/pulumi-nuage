...
export declare type Component = import("./component").Component;
...
export declare type ContainerRecipe = import("./containerRecipe").ContainerRecipe;
...
export declare type DistributionConfiguration = import("./distributionConfiguration").DistributionConfiguration;
...
export declare type ImageRecipe = import("./imageRecipe").ImageRecipe;
...
export declare type InfrastructureConfiguration = import("./infrastructureConfiguration").InfrastructureConfiguration;
