...
exports.getVpcIamPoolsOutput = exports.getVpcIamPools = void 0;
 ...
 * ```
 */
function getVpcIamPools(args, opts) {
    args = args || {};
    if (!opts) {
        opts = {};
    }
...
exports.getVpcIamPools = getVpcIamPools;
function getVpcIamPoolsOutput(args, opts) {
    return pulumi.output(args).apply(a => getVpcIamPools(a, opts));
}
exports.getVpcIamPoolsOutput = getVpcIamPoolsOutput;
//# sourceMappingURL=getVpcIamPools.js.map