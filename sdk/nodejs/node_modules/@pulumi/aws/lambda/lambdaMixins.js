...
class CallbackFunction extends function_1.Function {
    constructor(name, args, opts = {}) {
        ...
        code.isSecret = closure.then(c => c.containsSecrets);
        ...
        const functionArgs = Object.assign(Object.assign({}, args), { code: code, handler: serializedFileNameNoExtension + "." + handlerName, runtime: args.runtime || _1.Runtime.NodeJS16dX, role: role.arn, timeout: args.timeout === undefined ? 180 : args.timeout });
