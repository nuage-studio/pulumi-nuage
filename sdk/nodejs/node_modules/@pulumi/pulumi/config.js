...
class Config {
     ...
     */
    getImpl(key, opts, use, insteadOf) {
        const fullKey = this.fullKey(key);
        const v = getConfig(fullKey);
        if (v === undefined) {
            return undefined;
        }
    ...
    getBooleanImpl(key, use, insteadOf) {
        const v = this.getImpl(key, undefined, use, insteadOf);
        if (v === undefined) {
            return undefined;
        }
        else if (v === "true") {
    ...
    getNumberImpl(key, opts, use, insteadOf) {
        const v = this.getImpl(key, undefined, use, insteadOf);
        if (v === undefined) {
            return undefined;
        }
    ...
    getObjectImpl(key, use, insteadOf) {
        const v = this.getImpl(key, undefined, use, insteadOf);
        if (v === undefined) {
            return undefined;
        }
     ...
     */
    getObject(key) {
        return this.getObjectImpl(key, this.getSecretObject, this.getObject);
    }
    /**
     ...
     */
    getSecretObject(key) {
        const v = this.getObjectImpl(key);
        if (v === undefined) {
            return undefined;
        }
        return makeSecret(v);
    }
    requireImpl(key, opts, use, insteadOf) {
        const v = this.getImpl(key, opts, use, insteadOf);
        if (v === undefined) {
    ...
    requireBooleanImpl(key, use, insteadOf) {
        const v = this.getBooleanImpl(key, use, insteadOf);
        if (v === undefined) {
            throw new ConfigMissingError(this.fullKey(key));
        }
        return v;
    ...
    requireNumberImpl(key, opts, use, insteadOf) {
        const v = this.getNumberImpl(key, opts, use, insteadOf);
        if (v === undefined) {
            throw new ConfigMissingError(this.fullKey(key));
        }
        return v;
    ...
    requireObjectImpl(key, use, insteadOf) {
        const v = this.getObjectImpl(key, use, insteadOf);
        if (v === undefined) {
            throw new ConfigMissingError(this.fullKey(key));
        }
        return v;
     ...
     */
    requireObject(key) {
        return this.requireObjectImpl(key, this.requireSecretObject, this.requireObject);
    }
    /**
    ...
    requireSecretObject(key) {
        return makeSecret(this.requireObjectImpl(key));
    }
    /**
