...
`,
    ...
    while (true) {
        ...
        //     continue;
        // }
        it(test.title, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
            // Run pre-actions.
            if (test.pre) {
                test.pre();
            }
            ...
            if (test.expectText) {
                ...
                const message = yield util_1.assertAsyncThrows(() => __awaiter(void 0, void 0, void 0, function* () {
