...
describe("config", () => {
    ...
    it("does strongly typed too!", () => {
        ...
        assert.deepStrictEqual([0, false, 2, "foo"], config.getObject("array"));
        assert.deepStrictEqual([0, false, 2, "foo"], config.requireObject("array"));
        assert.deepStrictEqual({ "foo": "bar", "mim": [] }, config.getObject("struct"));
        assert.deepStrictEqual({ "foo": "bar", "mim": [] }, config.requireObject("struct"));
