...
describe("LocalWorkspace", () => {
    ...
    it(`nested_config`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const stackName = automation_1.fullyQualifiedStackName(getTestOrg(), "nested_config", "dev");
    ...
    it(`can list stacks and currently selected stack`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const stackNames = [];
        for (let i = 0; i < 2; i++) {
            const stackName = automation_1.fullyQualifiedStackName(getTestOrg(), projectName, stackNamer());
    ...
    xit(`runs through the stack lifecycle with a local program`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        const stackName = automation_1.fullyQualifiedStackName(getTestOrg(), "testproj", `int_test${getTestSuffix()}`);
    ...
    it(`successfully initializes multiple stacks`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const projectName = "inline_node";
        const stackNames = Array.from(Array(10).keys()).map(_ => automation_1.fullyQualifiedStackName(getTestOrg(), projectName, `int_test${getTestSuffix()}`));
    ...
    it.skip(`runs through the stack lifecycle with multiple inline programs in parallel`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        const program = () => __awaiter(void 0, void 0, void 0, function* () {
            const config = new index_1.Config();
            return {
                exp_static: "foo",
        ...
        yield Promise.all(stacks.map((stack) => __awaiter(void 0, void 0, void 0, function* () { return stack.setAllConfig(stackConfig); })));
        // pulumi up
    ...
    it.skip(`has secret config warnings`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        const program = () => __awaiter(void 0, void 0, void 0, function* () {
            const config = new index_1.Config();
    ...
    xit(`supports stack outputs`, util_1.asyncTest(() => __awaiter(void 0, void 0, void 0, function* () {
        const program = () => __awaiter(void 0, void 0, void 0, function* () {
            const config = new index_1.Config();
            return {
                exp_static: "foo",
