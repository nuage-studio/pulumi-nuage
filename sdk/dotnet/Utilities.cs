...
namespace Pulumi.Nuage
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Nuage.version.txt");
    ...
    internal sealed class NuageResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public NuageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
